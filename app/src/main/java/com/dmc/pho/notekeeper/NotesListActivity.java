package com.dmc.pho.notekeeper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                sendToMail.setData(Uri.parse("mailto:")); // only email apps should handle this
                sendToMail.putExtra(Intent.EXTRA_TEXT, "summary");
                sendToMail.putExtra(Intent.EXTRA_SUBJECT, "PROJECT ZEUS");
                sendToMail.putExtra(Intent.EXTRA_EMAIL, "phonum5@outlook.com");
            }
        });
